...
module.exports = {
    ...
    async execute({ client, inter }) {
        ...
        collector.on('collect', async (query) => {
            ...
            if (!value || value <= 0 || value > maxTracks.length) return inter.followUp({ content: `Resposta inválida, tente um valor entre **1** e **${maxTracks.length}** ou **cancelar**... tente novamente ? ❌`, ephemeral: true });
